...
if __name__ == '__main__':
    # _sets = ["(15+10)x8_newjob_breakdown", "(15+20)x8_newjob_breakdown", "(15+30)x8_newjob_breakdown", "(15+40)x8_newjob_breakdown", "(15+50)x8_newjob_breakdown"]
    # for _set in _sets:
    #     result_dir = './result/json/0229/{}'.format(_set)
    #     html_out_dir = './timeline/model/0229/{}'.format(_set)
    ...
    result_dir = './timeline/gaTest2'
    html_out_dir = './timeline/'
    if not os.path.exists(html_out_dir):
        os.makedirs(html_out_dir)
    for i, file_name in enumerate(os.listdir(result_dir)): 
        json_in_file = os.path.join(result_dir, file_name)
