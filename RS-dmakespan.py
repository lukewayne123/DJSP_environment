...
#    policy.load_state_dict(torch.load('./weight/RS_FJSP/best', map_location=args.device), False)
#    policy.load_state_dict(torch.load('./weight/0502RSmakespan_wAwB_try1/178000', map_location=args.device), False)
    policy.load_state_dict(torch.load('./weight/0611RSmakespan_wAwB_try2/165000', map_location=args.device), False)
